    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          // Recharts 3 utiliza novos seletores para acessibilidade e vetores
...
function ChartTooltipContent({
  ...
  nameKey,
  labelKey,
}: TooltipProps & // Alterado de React.ComponentProps para o tipo definido acima
  React.ComponentProps<"div"> & {
    hideLabel?: boolean;
...
function ChartLegendContent({
  ...
  // Em vez de Pick, definimos as props diretamente ou via interface
