  ...
  return (
    <>
      <DashboardHeader
        breadcrumbs={{
          items: [
            ...
            {
              name: selectedOrganization?.name || "Organization",
              path: `/dashboard/${selectedOrganization?.id}`,
            },
            {
              name: "Applications",
              path: `/dashboard/${selectedOrganization?.id}/application`,
            },
            {
              name: "Create Application",
              path: `/dashboard/${selectedOrganization?.id}/application/create-application`,
            },
          ],
        }}
      />
      ...
      <main className="flex flex-col p-4">
        <Link
          href={`/dashboard/${selectedOrganization?.id}?tab=applications`}
