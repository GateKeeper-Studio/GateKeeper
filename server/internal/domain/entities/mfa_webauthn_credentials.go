...
func NewMfaWebauthnCredentials(mfaMethodID uuid.UUID, credentialID, publicKey []byte, signCount uint32, backupEligible, backupState bool) (*MfaWebauthnCredentials, error) {
	id, err := uuid.NewV7()
	if err != nil {
		return nil, err
	}
